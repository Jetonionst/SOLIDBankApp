	...
	public static void main(String[] args) {
		...
		while (isExit) {
			...
			switch (str) {
				...
				case "3" -> System.out.println("Deposit has not been released yet.");
				case "4" -> System.out.println("Deposit has not been released yet.");
				case "5" -> System.out.println("Transfer has not been released yet.");
				case "6" -> help();
				case "7" -> {
					exit();
					isExit = false;
